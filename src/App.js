...
import BButton from './component/BBattons';
import BATable from './component/BATable';
    ...
    <>
      ...
      <div>
        ...
        <div className='d-flex align-items-center justify-content-around'>
          <BButton btnValue={ButtonData[0].name} city={ButtonData[0].city} />
          <BButton btnValue={ButtonData[1].name} city={ButtonData[1].city} />
          <BButton btnValue={ButtonData[2].name} city={ButtonData[2].city} />
          <BButton btnValue={ButtonData[3].name} city={ButtonData[3].city} />
        </div>
      </div>
      ...
      <div>
        ...
        <div className='d-flex align-items-center justify-content-around'>
          <BAInput inputType='text' inputValue='Henry James' />
          <BAInput inputType='password' inputValue='JohnDoe0123' />
          <BAInput inputType='email' inputValue='williamstone@gmail.com' />
        </div>
      </div>
